...
export default function AccountPage(){
    ...
    return(
        <Segment>
            ...
            <>
                <Header color='teal' content='Facebook account' />
            ...
            <>
                <Header color='teal' content='Google account' />
                <p>Please visit Google to update your account</p>
                <Button icon='google' color='google plus' as={Link} to='https://gmail.com' content='Go to Google' />
            </>}
        </Segment>
    )
}